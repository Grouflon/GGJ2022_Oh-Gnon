...
public class AgentManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 brWorldPoint = Camera.main.ScreenToWorldPoint(new Vector3(Screen.width - 50f, 50f, 0f));
        Vector3 tlWorldPoint = Camera.main.ScreenToWorldPoint(new Vector3(50f, Screen.height - 160f, 0f));
        brWorldPoint.z = 0f;
        tlWorldPoint.z = 0f;
